...
#define KEY_REGEN_X 30
#define KEY_REGEN_Y TOP_BOT_LINE_WIDTH + 25 
#define KEY_REGEN_SIZE_X 150
#define KEY_REGEN_SIZE_Y 150

#define KEY_REGEN_TEXT_X KEY_REGEN_X + 38
#define KEY_REGEN_TEXT_Y KEY_REGEN_Y + 58
