...
char* ITEM_SOFTENING[] = { "ÎÁÐ.ÏÐÎÌ.", "ÐÅÀÃ.ÏÐÎÌ.", "ÂÒÎÐÀß.ÏÐÎÌ.", "ÏÐßÌÀß.ÏÐÎÌ.", "ÇÀËÈÂÊÀ" };
...
void RefreshSofteningFrame(void)
{
    ...
    if(hwndSofteningFrameControl == -1 && startSofteningFrame == 1)
    {
        ...
        BSP_LCD_DisplayStringAt(350,FIRST_CURSOR_POS_Y + 17,"ÌÈÍ",LEFT_MODE);
        BSP_LCD_DisplayStringAt(350,SECOND_CURSOR_POS_Y + 17,"ÌÈÍ",LEFT_MODE);
        BSP_LCD_DisplayStringAt(350,THRID_CURSOR_POS_Y + 17,"ÌÈÍ",LEFT_MODE);
