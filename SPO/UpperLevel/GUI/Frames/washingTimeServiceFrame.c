...
void RefreshWashingTimeServiceFrame(void)
{
    ...
    BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
    BSP_LCD_DisplayStringAt(WASHING_TIME_VALUE_X + 150, WASHING_TIME_VALUE_Y, DAY, LEFT_MODE);
    BSP_LCD_SetBackColor(LCD_COLOR_LIGHTGRAY);
    BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
    BSP_LCD_DisplayStringAt(WASHING_TIME_VALUE_X + 250, WASHING_TIME_VALUE_Y, NIGHT, LEFT_MODE);
