...
void redrawGUI(void){
	...
	if (touchDelay == 0 && tsState.TouchDetected == 1 && frame == 0)
    {
		touchDelay = 300;
    ...
    if (touchDelay == 0 && tsState.TouchDetected == 1 && frame == 1)
    {
        touchDelay = 300;
    ...
    if(frame == 1)
    {
        ...
        BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
        BSP_LCD_DisplayStringAt(16,FIRST_CURSOR_POS_Y + 13,"SERVICE",LEFT_MODE);
        ...
        BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
        BSP_LCD_DisplayStringAt(16,SECOND_CURSOR_POS_Y + 13,"REGENERATION",LEFT_MODE);
        ...
        BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
        BSP_LCD_DisplayStringAt(16,THRID_CURSOR_POS_Y + 13,"FILTERING",LEFT_MODE);
        ...
        BSP_LCD_SetTextColor(LCD_COLOR_BLACK);
        BSP_LCD_SetBackColor(LCD_COLOR_LIGHTGRAY);
        BSP_LCD_DisplayStringAt(26,18,"R",CENTER_MODE);
        BSP_LCD_DisplayStringAt(TOP_BOT_LINE_WIDTH*2,18,"MODE",CENTER_MODE);
            
    }
    
    if(frame == 0 && dropBut == 0)
    {
        BSP_LCD_Clear(LCD_COLOR_WHITE);
        BSP_LCD_SetTextColor(LCD_COLOR_LIGHTGRAY);
        BSP_LCD_FillRect(MAINBAR_POS_X,MAINBAR_POS_Y, MAINBAR_SIZE_X, MAINBAR_SIZE_Y);
