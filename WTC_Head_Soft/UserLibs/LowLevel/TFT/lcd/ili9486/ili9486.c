...
//	LCD_WR_DATA(0x08, TRUE);
  ...
  LCD_Delay(10);
	...
	LCD_IO_WriteCmd8MultipleData8(ILI9486_INVCTR, (uint8_t *)"\x00", 1);
	LCD_Delay(5);
	
	LCD_IO_WriteCmd8MultipleData8(ILI9486_PWCTR2, (uint8_t *)"\x47", 1);
	LCD_Delay(5);
	
	LCD_IO_WriteCmd8MultipleData8(ILI9486_VMCTR1, (uint8_t *)"\x00\xAF\x80\x00", 4);
	LCD_Delay(5);
	...
	LCD_IO_WriteCmd8MultipleData8(ILI9486_PIXFMT, (uint8_t *)"\x66", 1);
	LCD_Delay(5);
