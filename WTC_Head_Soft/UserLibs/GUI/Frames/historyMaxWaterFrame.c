#include "historyMaxWaterFrame.h"

uint8_t history_maxwater_frame_Scroll_cnt = 0;
uint8_t history_maxwater_frame_was_Scroll = 0;
int8_t hwndHistoryMaxWaterFrameControl = 0;
int8_t startHistoryMaxWaterFrame = 0;
...
{
    history_maxwater_frame_Scroll_cnt = 0;
		/*Static create*/
		createFrame();
    while(1)
    {
...
//	BSP_LCD_DisplayStringAt(FIRST_CURSOR_POS_X + 9,FIRST_CURSOR_POS_Y + 9,ITEM_HISTORY_MENU[history_maxwater_frame_Scroll_cnt],LEFT_MODE);
//	BSP_LCD_DisplayStringAt(FIRST_CURSOR_POS_X + 9,SECOND_CURSOR_POS_Y + 9,ITEM_HISTORY_MENU[history_maxwater_frame_Scroll_cnt + 1],LEFT_MODE);
//	BSP_LCD_DisplayStringAt(FIRST_CURSOR_POS_X + 9,THRID_CURSOR_POS_Y + 9,ITEM_HISTORY_MENU[history_maxwater_frame_Scroll_cnt + 2],LEFT_MODE);
//	BSP_LCD_DisplayStringAt(FIRST_CURSOR_POS_X + 9,FOURTH_CURSOR_POS_Y + 9,ITEM_HISTORY_MENU[history_maxwater_frame_Scroll_cnt + 3],LEFT_MODE);
