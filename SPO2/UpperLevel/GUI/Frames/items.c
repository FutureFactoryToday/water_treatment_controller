...
const uint8_t* ITEM_IMPULSE_WEIGHT[] = {"1 л/имп","10 л/имп","100 л/имп","Вес импульса"};
...
const uint8_t* ITEM_MANUAL_SETTINGS[] = {"Ручная настройка", "Добавить стадию"};

const uint8_t* ITEM_WATER_BR[] = {"Расход воды", "м"};

const uint8_t* ITEM_SERVICE_INFO[] = {"Сервис", "Дата следующего сервисного", "обслуживания", "Сервис выполнен", "Необходимо провести сервис", "Следующее сервисное обслуживание","сделать через:", "0", "3", "6", "9", "12", "Месяцев"};
...
const uint8_t* ITEM_AC_OUTPUT_FRAME[] = {"ВЫХ2", "Работа с компрессором", "Промывка фильтра", "Не активен"};
