...
const uint8_t* ITEM_STEPS_WITH_MES[] = { "Фильтрация, c", "Прямая промывка, c", "Обратная промывка, c", "Засос солевого раствора", "и медленная отмывка, кг", "Заполнение солевого бака, с"};/*"Заполнение солевого бака и медленная отмывка"};*/ 
