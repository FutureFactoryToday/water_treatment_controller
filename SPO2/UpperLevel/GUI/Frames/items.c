...
const uint8_t* ITEM_STEPS[] = { "Фильтрация", "Прямая промывка", "Обратная промывка", "Засос солевого раствора", "и медленная отмывка", "Расход соли на регенерацию"};/*"Заполнение солевого бака и медленная отмывка"};*/ 

const uint8_t* ITEM_STEPS_WITH_MES[] = { "Фильтрация, мин", "Прямая промывка, мин", "Обратная промывка, мин", "Засос солевого раствора", "и медленная отмывка, мин", "Расход соли на"/*"Заполнение солевого бака"*/, "регенерацию, кг"};/*"Заполнение солевого бака и медленная отмывка"};*/ 
