...
const uint8_t* ITEM_STEPS_WITH_MES[] = { "Фильтрация, мин", "Прямая промывка, мин", "Обратная промывка, мин", "Засос солевого раствора", "и медленная отмывка, мин", "Расход соли на регенерацию"/*"Заполнение солевого бака"*/, "кг"};/*"Заполнение солевого бака и медленная отмывка"};*/ 
