...
void createFrame(void){
    ...
    uint16_t offsetFirst = BSP_LCD_DisplayStringAt(250,FIRST_CURSOR_POS_Y + 9,intToStr(0),LEFT_MODE);
	uint16_t offsetSecond = BSP_LCD_DisplayStringAt(250,SECOND_CURSOR_POS_Y + 9,intToStr(0),LEFT_MODE);
	uint16_t offsetThrid = BSP_LCD_DisplayStringAt(250,THRID_CURSOR_POS_Y + 9,intToStr(0),LEFT_MODE);
	uint16_t offsetFour = BSP_LCD_DisplayStringAt(250,FOURTH_CURSOR_POS_Y + 9,intToStr(0),LEFT_MODE);
