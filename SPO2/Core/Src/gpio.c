...
void MX_GPIO_Init(void)
{
  ...
  /**/
//  c
//	LL_GPIO_SetPinPull(OPTIC_SENS_GPIO_Port, OPTIC_SENS_Pin, LL_GPIO_PULL_UP);
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOA, TFT_RES_Pin|TFT_COM_EN_Pin|TOUCH_CS_Pin|MEM_WP_Pin
                          |ILED_Pin|MEM_CS_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = TFT_RES_Pin|TFT_COM_EN_Pin|TOUCH_CS_Pin|MEM_WP_Pin
                          |ILED_Pin|MEM_CS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
