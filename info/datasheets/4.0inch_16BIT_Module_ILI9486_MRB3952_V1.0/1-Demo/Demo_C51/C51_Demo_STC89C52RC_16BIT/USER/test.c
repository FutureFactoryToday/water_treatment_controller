...
//本模块默认数据总线类型为16位并口
//液晶屏模块             C51单片机
// DB0~DB7       接       P30~P37        //数据低8位（8位模式：DB0~DB7接P30~P37）
...
//触摸屏使用的数据总线类型为SPI
//触摸屏模块             C51单片机
//  EX_CLK       接        P36          //触摸屏SPI时钟信号
//  TP_CS        接        P37          //触摸屏片选控制信号
//  MOSI         接        P34          //触摸屏SPI写信号
//  MISO         接        P35          //触摸屏SPI读信号
//  TP_IRQ       接        P40          //触摸屏响应检查信号，如单片机无P4组，请自行更改其他可用IO并修改代码定义
//**************************************************************************************************/	
#include "lcd.h"
#include "string.h"
#include "sys.h"
...
void main_test(void)
{
	...
	Gui_StrCenter(0,90,MAGENTA,BLUE,"3.95\" ILI9486 320X480",16,1);//居中显示
	Gui_StrCenter(0,120,BLUE,BLUE,"xiaoFeng@QDtech 2019-05-07",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
